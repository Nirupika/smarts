...
$where = " WHERE status='waiting-list' ";
$params = [];

if (!empty($_GET['search'])) {

    $where .= " AND (
        application_no LIKE :search
        OR student_full_name LIKE :search
...
/* Load Waiting List Applications */
...
<div class="alert alert-primary">
    ...
    Total Waiting List Applications :
    ...
    <?php } else { ?>
        ...
        <tr>
            ...
            <td colspan="6"
                ...
                No Waiting List Applications Found
